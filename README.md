...
- ✅ **AI-Powered**: Features AI commands for asking questions, summarizing text, and getting jokes, powered by a local text generation model (defaulting to GPT-2).
...
-   **AI Model Refactoring**: The AI functionality has been refactored to use a single local text generation model (defaulting to GPT-2) for all AI commands (`ask`, `summarize`, `jokeplease`). The previous specialized models and the attempted Google Coral integration have been removed.
